            ...
            <tbody>
              <tr>
                <td style="font-size: 6px; line-height: 10px; padding: 0px 0px 0px 0px" valign="top" align="center">
                  <img src="../img/logos/banner.jpg" border="0" style="display: block; max-width: 100% !important; width: 100%; height: auto !important;" alt="" width="600" tabindex="0"/>
                </td>
              </tr>
            </tbody>
          </table><!-- Header -->
                ...
                <td height="100%" valign="top">
                  ...
                  <div style="margin-left: 20px; margin-right: 20px">
                    ...
                    <div style="width: 100%; text-align: center">
                      <span style="font-family: Nunito; color: #75787b; font-size: 16px; font-weight: 700">
                        Estimado paciente, le adjuntamos la siguiente solicitud de contacto:
                      </span>
                    </div>
                    ...
                    <div style="font-size: 16px">
                      ...
                      <div style=" border-color: #235b90; border-style: solid; border-radius: 10px; border-width: 2px; padding: 5px; margin-top: 20px; margin-bottom: 20px;">
                        ...
                        <span style="font-family: Nunito; color: #75787b; font-weight: 600"></span>
                      </div><!-- Solicitante -->
                      ...
                      <!-- Lugar -->
                      <div style=" border-color: #235b90; border-style: solid; border-radius: 10px; border-width: 2px; padding: 5px; margin-top: 20px; margin-bottom: 20px;">
                        <span style="font-family: Nunito; color: #235b90; margin-right: 54px; padding-left: 5px; font-weight: bold">Lugar:</span>
                        <span style="font-family: Nunito; color: #75787b; font-weight: 600"></span>
                      </div><!-- Lugar -->
                        ...
                        <tr>
                          ...
                          <td width="40%" align="right" valign="center">
                            <span style="text-align: right; font-size: 14px; font-weight: 600; color: #75787b">
                              <a href="http://200.111.199.219:84/" style="
