...
echo "<script>alert('Los campos marcados con * son obligatorios');location.href ='javascript:history.back()';</script>";
    ...
    $mail->AddAddress("raulfaria@gmail.com"); // Dirección a la que llegaran los mensajes.
...
// Datos del servidor SMTP
    ...
    $mail->Username = 'inversalud.cl@gmail.com';  // Tu correo gmail
    $mail->Password = 'TBnIBpO*3SAH'; // Tu contrasena gmail
    $mail->FromName = 'InverSalud'; // 
    $mail->From = 'inversalud.cl@gmail.com'; //email de remitente desde donde se envía el correo, este caso para evitar spam es el mismo que tu correo gmail
